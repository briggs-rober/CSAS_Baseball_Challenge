...
plot_by_outs(data, outs = 0, batter = 660271, color = 'green', label = 'No Outs')
plot_by_outs(data, outs = 1, batter = 660271, color = 'purple', label = 'One Out')
plot_by_outs(data, outs = 2, batter = 660271, color = 'blue', label = 'Two Outs')
